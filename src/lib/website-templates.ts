...
export const WEBSITE_TEMPLATES = [
  ...
  {
    value: 'fullscreen-gallery',
    label: 'Full Screen Gallery',
    description: 'Immersive full-bleed images, zero distractions',
    fontFamily: '"Cormorant Garamond", Georgia, serif',
    uiFontFamily: '"DM Sans", sans-serif',
    bg: '#000000',
    text: '#F5F5F0',
  ...
  {
    value: 'story-portfolio',
    label: 'Story Based Portfolio',
    description: 'Scroll-driven narrative with large editorial sections',
    fontFamily: '"Playfair Display", Georgia, serif',
    uiFontFamily: '"Cormorant Garamond", Georgia, serif',
    bg: '#F8F6F1',
    text: '#1C1A15',
    textSecondary: '#7A7567',
    navBg: 'rgba(248,246,241,0.95)',
    navBorder: 'rgba(28,26,21,0.08)',
    headerStyle: 'fixed' as const,
    heroStyle: 'story' as const,
    cardBg: '#FFFFFF',
    footerBg: '#1C1A15',
    footerText: '#A09B8E',
  },
