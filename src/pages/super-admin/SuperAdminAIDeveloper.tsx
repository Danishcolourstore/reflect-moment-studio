...
const CODEBASE_MEMORY: MemoryEntry[] = [
  {
    feature: 'Authentication',
    keywords: ['auth', 'login', 'signup', 'password', 'session', 'user'],
    pages: ['Auth.tsx', 'ForgotPasswordPage.tsx', 'ResetPassword.tsx', 'VerifyOTP.tsx'],
    components: ['OtpInput.tsx'],
    hooks: [],
    apis: [],
    dbTables: ['profiles', 'user_roles'],
    description: 'Email+password auth via Supabase. Roles in user_roles table with has_role() function. Auth context in src/lib/auth.tsx.',
  },
  {
    feature: 'Gallery System',
    keywords: ['gallery', 'photo', 'image', 'lightbox', 'masonry', 'watermark', 'slideshow'],
    pages: ['EventGallery.tsx', 'PublicGallery.tsx', 'GalleryCover.tsx'],
    components: ['GalleryShell.tsx', 'PhotoLightbox.tsx', 'GalleryPasswordGate.tsx', 'PhotoSlideshow.tsx', 'ProgressiveImage.tsx', 'GalleryTextBlock.tsx', 'EditorialCollageGrid.tsx', 'PremiumGridLayouts.tsx'],
    hooks: ['use-infinite-photos.ts', 'use-guest-favorites.ts', 'use-guest-session.ts'],
    apis: ['send-gallery-view-notification'],
    dbTables: ['events', 'photos', 'favorites', 'guest_sessions', 'gallery_chapters', 'gallery_text_blocks', 'event_analytics', 'event_views'],
    description: 'Multi-layout gallery with masonry/grid/editorial styles, password protection, guest favorites, chapters, and analytics tracking.',
  },
  {
    feature: 'Event Management',
    keywords: ['event', 'wedding', 'create event', 'slug', 'publish', 'archive'],
    ...
    description: 'CRUD for photo events with slug-based URLs, gallery settings, layout options, download controls, and publishing.',
  },
  {
    feature: 'Client Management',
    keywords: ['client', 'invite', 'client portal', 'client dashboard'],
    ...
    description: 'Client invitation, portal access, favorites, downloads. Clients linked to photographers via photographer_id.',
  },
  {
    feature: 'Dashboard',
    keywords: ['dashboard', 'overview', 'stats', 'widget', 'navigation'],
    pages: ['Dashboard.tsx'],
    ...
    description: 'Photographer dashboard with configurable widgets, navigation, and modules. Super Admin can customize layout.',
  },
  {
    feature: 'Album Designer',
    keywords: ['album', 'album design', 'spread', 'page layout', 'print'],
    pages: ['AlbumDesigner.tsx', 'AlbumEditorPage.tsx', 'AlbumPreviewPage.tsx'],
    components: ['album-designer/AlbumCanvas.tsx', 'album-designer/AlbumTimeline.tsx', 'album-designer/AlbumEditorToolbar.tsx', 'album-designer/AlbumPhotoPanel.tsx', 'album-designer/AlbumPreviewModal.tsx', 'album-designer/AlbumExportDialog.tsx', 'album-designer/NewAlbumWizard.tsx'],
    hooks: [],
    apis: [],
    dbTables: ['albums', 'album_pages', 'album_layers', 'album_selections'],
    description: 'Visual album design tool with drag-drop layers, spreads, photo panels, auto-layout, and PDF export.',
  },
  {
    feature: 'Website Builder',
    keywords: ['website', 'portfolio', 'studio website', 'website editor', 'template'],
    pages: ['WebsiteEditor.tsx', 'TemplatePreview.tsx'],
    components: ['website/WebsiteHero.tsx', 'website/WebsiteAbout.tsx', 'website/WebsitePortfolio.tsx', 'website/WebsiteContact.tsx', 'website/WebsiteFooter.tsx', 'website/WebsiteTestimonials.tsx', 'website/WebsiteServices.tsx', 'website/WebsiteInquiryForm.tsx'],
    hooks: ['use-website-templates.ts', 'use-portfolio-photos.ts'],
    apis: [],
    dbTables: ['studio_profiles', 'portfolio_albums', 'blog_posts', 'contact_inquiries'],
    description: 'Portfolio website builder with multiple templates, section editors, blog, and contact forms.',
  },
  {
    feature: 'Grid Builder',
    keywords: ['grid', 'instagram', 'carousel', 'collage', 'social media'],
    pages: ['BuilderTest.tsx'],
    components: ['grid-builder/GridBuilder.tsx', 'grid-builder/GridEditor.tsx', 'grid-builder/GridCell.tsx', 'grid-builder/TextOverlay.tsx', 'grid-builder/LogoOverlay.tsx', 'grid-builder/CarouselExporter.tsx', 'grid-builder/AICaptionGenerator.tsx'],
    hooks: ['use-grid-templates.ts'],
    apis: ['generate-caption', 'analyze-grid-layout', 'suggest-layout'],
    dbTables: ['grid_templates'],
    description: 'Instagram grid/carousel builder with text overlays, logo placement, AI captions, and export tools.',
  },
  {
    feature: 'Cheetah AI Culling',
    keywords: ['cheetah', 'cull', 'culling', 'ai photo', 'photo analysis', 'best photo'],
    ...
    description: 'AI-powered photo culling with sharpness/composition scoring, burst grouping, and best-of selection.',
  },
  {
    feature: 'Branding',
    keywords: ['brand', 'logo', 'watermark', 'typography', 'studio profile'],
    pages: ['Branding.tsx', 'BrandEditor.tsx'],
    components: ['brand/BrandAssets.tsx', 'brand/BrandTypography.tsx', 'brand/BrandWatermark.tsx', 'brand-editor/StudioLivePreview.tsx'],
    hooks: [],
    apis: [],
    dbTables: ['studio_profiles'],
    description: 'Brand management with logo upload, watermark settings, typography, and live studio preview.',
  },
  {
    feature: 'Analytics',
    keywords: ['analytics', 'stats', 'views', 'downloads', 'tracking'],
    pages: ['Analytics.tsx'],
    components: [],
    hooks: ['use-analytics.ts'],
    apis: [],
    dbTables: ['event_analytics', 'event_views', 'photo_interactions'],
    description: 'Gallery analytics dashboard with views, downloads, favorites tracking, and time-series charts.',
  },
  {
    ...
    description: 'In-app notifications for gallery views, comments, selections, and client actions.',
  },
  {
    feature: 'Guest Features',
    keywords: ['guest', 'selection', 'favorite', 'face', 'selfie', 'qr'],
    pages: ['GuestFinder.tsx', 'VerifyAccess.tsx'],
    components: ['GuestSelectionMode.tsx', 'GuestSelectionsViewer.tsx', 'GuestFavoritesTab.tsx', 'FindMyPhotosModal.tsx', 'events/SmartQRAccess.tsx'],
    ...
    dbTables: ['guest_sessions', 'guest_selections', 'guest_selection_photos', 'guest_registrations', 'guest_selfies', 'event_qr_access', 'face_indexing_jobs'],
    description: 'Guest photo selection, favorites, face recognition (Find My Photos), QR access, and PIN verification.',
  },
  {
    feature: 'Storybooks',
    keywords: ['storybook', 'story', 'narrative'],
    ...
    dbTables: ['storybooks', 'storybook_blocks'],
    description: 'Visual storybook creator with blocks, OTP-gated sharing, and preview layouts.',
  },
  {
    feature: 'Admin Panel',
    keywords: ['admin', 'super admin', 'moderation', 'platform'],
    pages: ['admin/AdminDashboard.tsx', 'admin/AdminPhotographers.tsx', 'admin/AdminSettings.tsx', 'admin/AdminActivity.tsx', 'admin/AdminEmails.tsx', 'admin/AdminEvents.tsx', 'admin/AdminRevenue.tsx', 'admin/AdminStorage.tsx'],
    components: [],
    hooks: [],
    ...
    description: 'Admin panel with user management, activity logs, platform settings, email tools, and revenue tracking.',
  },
  {
    feature: 'Super Admin',
    keywords: ['super admin', 'ai developer', 'template builder', 'platform builder'],
    ...
    dbTables: ['ai_developer_prompts', 'dashboard_widgets', 'dashboard_navigation', 'dashboard_modules', 'dashboard_settings', 'dashboard_layouts'],
    description: 'Super Admin panel with AI developer console, template management, platform builder, and dashboard editor.',
  },
  {
    feature: 'Upload System',
    keywords: ['upload', 'photo upload', 'zip', 'bulk upload', 'livesync'],
    ...
    description: 'Multi-file and ZIP upload with progress tracking, compression, livesync, and folder watching.',
  },
  {
    feature: 'Sharing',
    keywords: ['share', 'embed', 'widget', 'link'],
    pages: ['WidgetPage.tsx'],
    components: ['ShareModal.tsx', 'PhotoShareSheet.tsx', 'GalleryEmbedWidget.tsx'],
    hooks: [],
    apis: [],
    dbTables: ['events'],
    description: 'Gallery sharing via links, embeddable widgets, and share sheets.',
  },
];

// ──── Context Injection: match prompt keywords to memory ────
function getRelevantContext(promptText: string): string {
  const lower = promptText.toLowerCase();
  const matched = CODEBASE_MEMORY.filter(m =>
...
const PROJECT_TREE: FolderNode[] = [
  { name: 'src', type: 'folder', children: [
    { name: 'pages', type: 'folder', icon: 'LayoutGrid', children: [
      { name: 'Auth.tsx', type: 'file' }, { name: 'Dashboard.tsx', type: 'file' },
      { name: 'Events.tsx', type: 'file' }, { name: 'EventGallery.tsx', type: 'file' },
      { name: 'PublicGallery.tsx', type: 'file' }, { name: 'Analytics.tsx', type: 'file' },
      { name: 'Clients.tsx', type: 'file' }, { name: 'Profile.tsx', type: 'file' },
      { name: 'Billing.tsx', type: 'file' }, { name: 'Branding.tsx', type: 'file' },
      { name: 'BrandEditor.tsx', type: 'file' }, { name: 'WebsiteEditor.tsx', type: 'file' },
      { name: 'AlbumDesigner.tsx', type: 'file' }, { name: 'Cheetah.tsx', type: 'file' },
      { name: 'StorybookCreator.tsx', type: 'file' }, { name: 'UploadPage.tsx', type: 'file' },
      { name: 'LandingPage.tsx', type: 'file' }, { name: 'Notifications.tsx', type: 'file' },
      { name: 'admin/', type: 'folder', children: [
        { name: 'AdminDashboard.tsx', type: 'file' }, { name: 'AdminPhotographers.tsx', type: 'file' },
        { name: 'AdminSettings.tsx', type: 'file' },
      ]},
      { name: 'super-admin/', type: 'folder', children: [
        { name: 'SuperAdminOverview.tsx', type: 'file' }, { name: 'SuperAdminUsers.tsx', type: 'file' },
        { name: 'SuperAdminAIDeveloper.tsx', type: 'file' }, { name: 'SuperAdminSettings.tsx', type: 'file' },
        { name: 'SuperAdminTemplates.tsx', type: 'file' }, { name: 'SuperAdminGalleries.tsx', type: 'file' },
      ]},
      { name: 'client/', type: 'folder', children: [
        { name: 'ClientDashboard.tsx', type: 'file' }, { name: 'ClientEvents.tsx', type: 'file' },
        { name: 'ClientFavorites.tsx', type: 'file' },
      ]},
    ]},
    { name: 'components', type: 'folder', icon: 'Layers', children: [
      { name: 'ui/', type: 'folder', children: [{ name: '40+ shadcn/ui primitives', type: 'file' }] },
      { name: 'website/', type: 'folder', children: [{ name: '25+ website sections', type: 'file' }] },
      { name: 'album-designer/', type: 'folder', children: [{ name: '8 album components', type: 'file' }] },
      { name: 'grid-builder/', type: 'folder', children: [{ name: '15+ grid tools', type: 'file' }] },
      { name: 'brand-editor/', type: 'folder', children: [{ name: '3 brand tools', type: 'file' }] },
      { name: 'GalleryShell.tsx', type: 'file' }, { name: 'PhotoLightbox.tsx', type: 'file' },
      { name: 'DashboardLayout.tsx', type: 'file' }, { name: 'AppSidebar.tsx', type: 'file' },
    ]},
    { name: 'hooks', type: 'folder', icon: 'Cpu', children: [
  ...
  { name: 'supabase', type: 'folder', children: [
    { name: 'functions/', type: 'folder', children: [
      { name: 'ai-chat/', type: 'folder', children: [{ name: 'index.ts', type: 'file' }] },
      { name: 'ai-developer/', type: 'folder', children: [{ name: 'index.ts', type: 'file' }] },
      { name: 'cheetah-analyze/', type: 'folder', children: [{ name: 'index.ts', type: 'file' }] },
      { name: 'invite-client/', type: 'folder', children: [{ name: 'index.ts', type: 'file' }] },
      { name: 'generate-caption/', type: 'folder', children: [{ name: 'index.ts', type: 'file' }] },
      { name: 'send-welcome-email/', type: 'folder', children: [{ name: 'index.ts', type: 'file' }] },
    ]},
...
const DB_TABLES = [
  { name: 'profiles', columns: 15, desc: 'User profiles & settings' },
  { name: 'events', columns: 28, desc: 'Photo events/galleries' },
  { name: 'photos', columns: 10, desc: 'Individual photos' },
  { name: 'favorites', columns: 5, desc: 'Guest favorites' },
  { name: 'clients', columns: 7, desc: 'Client records' },
  { name: 'albums', columns: 12, desc: 'Album projects' },
  { name: 'storybooks', columns: 9, desc: 'Storybook projects' },
  { name: 'notifications', columns: 9, desc: 'In-app notifications' },
  { name: 'studio_profiles', columns: 30, desc: 'Public website data' },
  { name: 'grid_templates', columns: 14, desc: 'Grid templates' },
  { name: 'platform_settings', columns: 4, desc: 'Feature flags' },
  { name: 'user_roles', columns: 3, desc: 'RBAC roles' },
  { name: 'ai_developer_prompts', columns: 10, desc: 'AI prompt history' },
  { name: 'event_analytics', columns: 6, desc: 'Gallery analytics' },
  { name: 'contact_inquiries', columns: 7, desc: 'Contact forms' },
  { name: 'blog_posts', columns: 10, desc: 'Blog content' },
];
