  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center px-4">
      <div className="text-center space-y-4">
        <h1 className="text-7xl font-light text-[#C9A96E]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          404
        </h1>
        ...
        <a
          ...
          className="inline-block mt-4 px-6 py-2.5 rounded-lg bg-[#C9A96E] text-white text-sm hover:bg-[#b8985d] transition-colors"
