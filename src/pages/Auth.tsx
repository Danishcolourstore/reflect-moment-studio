  ...
  return (
    ...
    >
      ...
      >
        {/* Title */}
        <h2
          className="text-center text-[#F5F0E8] tracking-wide mb-1"
          style={{
        ...
        <form onSubmit={isLogin ? handleLogin : handleSignup} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 bg-[#161616]/60 border border-[#ffffff12] rounded-lg px-3 h-11 focus-within:border-[#C9A96E] transition-colors">
              <Mail className="h-4 w-4 text-[#6A6A6A] shrink-0" />
              <input
                type="email"
                value={email}
          ...
          <div>
            ...
            <div className="flex items-center gap-3 bg-[#161616]/60 border border-[#ffffff12] rounded-lg px-3 h-11 focus-within:border-[#C9A96E] transition-colors">
              <Lock className="h-4 w-4 text-[#6A6A6A] shrink-0" />
              <input
                type="password"
                value={password}
          ...
          {isLogin && (
            <button
              ...
              className="flex items-center justify-center gap-3 w-full h-12 rounded-lg bg-white hover:bg-gray-100 transition-colors"
            >
              ...
              <span className="text-[14px] font-medium text-[#333]">Sign in with Google</span>
            </button>
          )}
        </form>
