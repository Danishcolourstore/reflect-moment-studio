      ...
      <div className="space-y-2">
        {menuItems.map((item) => (
          <button
            ...
            className="w-full flex items-center gap-4 bg-card border border-border rounded-2xl px-5 py-4 active:scale-[0.98] transition-all hover:border-primary/30"
          >
        ...
        <button
          ...
          className="w-full flex items-center gap-4 bg-card border border-destructive/20 rounded-2xl px-5 py-4 active:scale-[0.98] transition-all mt-4"
        >
