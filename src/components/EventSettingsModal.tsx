...
export function EventSettingsModal({ open, onOpenChange, event, onUpdated }: EventSettingsModalProps) {
  ...
  const [galleryStyle, setGalleryStyle] = useState<GalleryStyleValue>(
    (event.gallery_style as GalleryStyleValue) || "vogue-editorial",
  );
  ...
  const [websiteTemplate, setWebsiteTemplate] = useState<WebsiteTemplateValue>(
    (event.website_template as WebsiteTemplateValue) || "vows-elegance",
  );
  ...
  const handleSave = async () => {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        hero_couple_name: heroCoupleName || null,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-card border-border/20 p-0 max-h-[90vh] overflow-y-auto">
        <DialogHeader className="px-8 pt-8 pb-2">
          <DialogTitle className="font-serif text-2xl" style={{ fontWeight: 300 }}>
            Event Settings
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="px-8 pb-8 space-y-8">
          ...
          <section className="space-y-4">
            <h3 className="font-serif text-base text-foreground tracking-wide" style={{ fontWeight: 400 }}>
              Basic Info
            </h3>
            <div className="space-y-1.5">
              ...
              <div className="flex gap-1.5">
                <Input
                  ...
                  readOnly
                  className="bg-background h-9 text-[12px] font-mono"
                />
                <Button
                  variant="outline"
                  size="icon"
            ...
            <div className="space-y-1.5">
              ...
              {event.cover_url && !coverFile && (
                <p className="editorial-helper">Current cover set. Upload a new image to replace.</p>
              )}
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="editorial-helper !mt-0">
              Choose how guests experience your gallery — like visiting your own website.
            </p>
            <div className="grid grid-cols-1 gap-2">
              {wsTemplates.map((tmpl) => (
                ...
                >
                  <span
                    className={`text-[11px] font-medium ${websiteTemplate === tmpl.value ? "text-foreground" : "text-muted-foreground/70"}`}
                  >
                    {tmpl.label}
                  </span>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {GALLERY_STYLES.map((style) => (
                ...
                >
                  <span
                    className={`text-[11px] font-medium ${galleryStyle === style.value ? "text-foreground" : "text-muted-foreground/70"}`}
                  >
                    {style.label}
                  </span>
            ...
            <>
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    value={heroCoupleName}
                    onChange={(e) => setHeroCoupleName(e.target.value)}
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Photography by Studio Name"
                    className="bg-background h-9 text-[13px]"
                  />
                </div>
                <div className="space-y-1.5">
            ...
            <div className="border border-border/20 bg-background/50 p-3 rounded-xl">
              ...
              <div className="flex gap-[2px] items-end h-12">
                {previewBars.map((h, i) => (
                  <div
                    key={`${galleryLayout}-${i}`}
                    className="flex-1 bg-muted-foreground/12 rounded-sm transition-all duration-300"
          ...
          <section className="space-y-4">
            ...
            <div className="flex items-center justify-between py-1">
              <div>
                ...
                <p className="editorial-helper !mt-0.5">
                  Allow guests to curate and submit their favorite photo selections.
                </p>
              </div>
