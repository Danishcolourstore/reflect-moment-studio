import { LayoutDashboard, CalendarDays, BookOpen, BarChart3, Settings, CreditCard, LogOut } from 'lucide-react';
  ...
  return (
    <aside className="fixed left-0 top-0 z-30 hidden h-screen w-[220px] flex-col bg-sidebar text-sidebar-foreground lg:flex border-r border-sidebar-border">
      ...
      <div className="px-6 pt-8 pb-6">
        ...
        <p className="mt-1.5 text-[9px] text-sidebar-foreground/30 tracking-[0.12em] uppercase truncate font-medium">{studioName}</p>
      </div>
