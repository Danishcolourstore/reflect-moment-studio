  ...
  if (clients.length === 0) {
    return (
      <div className="py-24 text-center flex flex-col items-center gap-6">
        ...
        <button
          onClick={onInvite}
          className="h-11 px-6 text-[13px] font-medium tracking-[0.06em] uppercase text-[#FAFAF8] bg-[#1A1A1A] hover:bg-[#1A1A1A] transition-colors transition-duration:120ms__PLACEHOLDER"
        >
          Add client
        </button>
      </div>
