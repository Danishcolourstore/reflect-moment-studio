...
import { LayoutDashboard, Camera, Heart, Download, User, LogOut, Moon, Sun, ChevronRight, Menu } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <aside className="fixed left-0 top-0 z-30 hidden h-screen w-[240px] flex-col bg-sidebar text-sidebar-foreground lg:flex border-r border-sidebar-border">
        <div className="px-6 pt-7 pb-4">
          ...
          <p className="text-[9px] text-sidebar-foreground/30 tracking-[0.14em] uppercase mt-1 font-medium">
            Client Portal
          </p>
        </div>
        ...
        <div className="px-5 py-5 flex flex-col items-center text-center">
          <Avatar className="h-14 w-14 mb-2.5">
            <AvatarFallback className="bg-sidebar-accent text-sidebar-foreground text-sm font-serif">
              {initials}
            </AvatarFallback>
          </Avatar>
      ...
      {/* Main content */}
      <main className="lg:ml-[240px] pt-16 pb-28 lg:pb-0 overflow-y-auto">
