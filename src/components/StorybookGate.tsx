        ...
        {step === 'email' ? (
          <form onSubmit={handleEmailSubmit} className="flex flex-col gap-4">
            <input
              ...
              className="h-12 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-white/30 text-center outline-none focus:border-[#1A1A1A] transition-colors px-4"
            ...
            <button
              ...
              style={{ background: '#1A1A1A', color: '#000', fontFamily: "'DM Sans', sans-serif", fontSize: '13px', fontWeight: 600, letterSpacing: '0.05em' }}
            >
              Continue
            </button>
          </form>
          ...
          <div className="flex flex-col gap-4">
            <div
              className="flex items-center px-4 h-12 rounded-xl transition-all duration-200 focus-within:border-[#1A1A1A]"
            ...
            <button
              ...
              style={{ background: '#1A1A1A', color: '#000', fontFamily: "'DM Sans', sans-serif", fontSize: '13px', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase' }}
            >
              Verify & Continue
            </button>
          </div>
